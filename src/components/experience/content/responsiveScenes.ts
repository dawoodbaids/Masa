...
export const SCENES={mobile:{scale:1.3,horizontal:.92,vertical:.9,depth:.78,rotation:.9,cameraZ:5.35,anatomyCameraZ:5.9},tablet:{scale:1.13,horizontal:.9,vertical:.92,depth:.88,rotation:.94,cameraZ:5.15,anatomyCameraZ:5.65},desktop:{scale:1,horizontal:1,vertical:1,depth:1,rotation:1,cameraZ:4.85,anatomyCameraZ:5.43}} as const;
